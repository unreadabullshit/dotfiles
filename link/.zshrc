...
# Basic aliases
alias ls='eza -l --icons --group-directories-first --git-repos --git --no-user --no-permissions -a --show-symlinks --time-style=long-iso'
alias fs='y'
alias tx='tmux'
alias lg='lazygit'

alias air-update='nix flake update --flake ~/nix && air-rebuild'
alias air-rebuild='darwin-rebuild switch --flake ~/nix#air'
